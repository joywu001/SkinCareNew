...
public class price_doctor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.price_doctor);
        ...
        JsonFetchD jsonFetchD = new JsonFetchD();
        jsonFetchD.execute();
    }

    public class JsonFetchD extends AsyncTask<String, String, String> {
