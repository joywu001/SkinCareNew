...
public class Needs_drySkin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonFetchDry jsonFetchDry = new JsonFetchDry();
        jsonFetchDry.execute();
    }

    public class JsonFetchDry extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                URL url = new URL("http://140.136.151.160/dryskin.php");
